function myperceptron_XOR_53384654
...
%Creamos un array de pesos con el mismo número de elementos que n_inputs
...
a = 1; %Parámetro "a" de la función sigmoidal
    ...
    for i=1:length(input(:,1))
        ...
        y = 1/(1+exp(-a*local_field)); %Salida del perceptrón
...
a=1;
    for i=1:length(input(:,1))
        ...
        out(i) = 1/(1+exp(-a*local_field)); %Salida del perceptrón 
    end
