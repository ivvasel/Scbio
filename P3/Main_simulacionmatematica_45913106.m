%%Realizado por Iván Valencia Sellés

%En este script adjuntaré todas las funciones utilizadas para crear la app
%de la práctica

%Ejecutando la app en el ordenador se pueden ver las gráficas correctamente
%sin necesidad de este archivo.
...
function mainHH_12 = mainHH_Euler_12ps_45913106
%==============================
%% HODKING-HUXLEY MODEL NEURAL CELL MODEL
%============================== 
...
dt=0.05; % Time Step ms
t=0:dt:100; %Time Array ms
Iap=0.55; %External Current Applied
ENa=55.17; % mv Na reversal potential
EK=-72.14; % mv K reversal potential
El=-49.42; % mv Leakage reversal potential
gbarNa=1.2; % mS/cm^2 Na conductance
...
%Introducimos inputs en la función para hacerla parametrizable
load('AP_ventriculo.mat');
% r=30; %retraso
% activaciones=5;
AP_sano_aux=[];
AP_isch_aux=[];
t=length(AP_sano)*activaciones; %Obtenemos t para poder plotear en el design
